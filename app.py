...
def encrypt_image():
    ...
    encrypted_image_path = os.path.join('uploads', f"encrypted_{filename}")
    img.imsave(encrypted_image_path, encrypted_image)

    decrypted_image_path = os.path.join('uploads', f"decrypted_{filename}")
    img.imsave(decrypted_image_path, image)
